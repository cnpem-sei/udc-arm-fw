...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(28, 0, 4, false, I_ARM_1.u8);
    create_bsmp_var(29, 0, 4, false, I_ARM_2.u8);
    ...
    create_bsmp_var(33, 0, 4, false, DUTY_CYCLE_MOD_2.u8);
    create_bsmp_var(34, 0, 4, false, DUTY_ARMS_DIFF.u8);
}
