...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(28, 0, 4, false, V_CAPBANK.u8);

    create_bsmp_var(29, 0, 4, false, DUTY_CYCLE.u8);

    // Output Module
    create_bsmp_var(30, 0, 4, false, iib_output_stage.Iin.u8);
    create_bsmp_var(31, 0, 4, false, iib_output_stage.Iout.u8);
    create_bsmp_var(32, 0, 4, false, iib_output_stage.VdcLink.u8);
    create_bsmp_var(33, 0, 4, false, iib_output_stage.TempIGBT1.u8);
    create_bsmp_var(34, 0, 4, false, iib_output_stage.TempIGBT2.u8);
    create_bsmp_var(35, 0, 4, false, iib_output_stage.TempL.u8);
    create_bsmp_var(36, 0, 4, false, iib_output_stage.TempHeatSink.u8);
    create_bsmp_var(37, 0, 4, false, iib_output_stage.Driver1Error.u8);
    create_bsmp_var(38, 0, 4, false, iib_output_stage.Driver2Error.u8);

    create_bsmp_var(39, 0, 4, false, IIB_ITLK_REG.u8);
}
