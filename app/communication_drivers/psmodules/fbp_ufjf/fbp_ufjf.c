...
#define I_L_MOD1_K_1            g_controller_ctom.net_signals[3]    //  |
#define V_D_MOD1_K_1            g_controller_ctom.net_signals[4]    // STATE_OBSERVER_IN
#define M_MOD1_K_1              g_controller_ctom.net_signals[5]    //  |     -----
#define I_LOAD_K                g_controller_ctom.net_signals[6]    //  |       |
#define V_C_MOD1_K              g_controller_ctom.net_signals[7]    //-----     |
#define I_L_MOD1_K              g_controller_ctom.net_signals[8]    //         STATE_CONTROLLER_IN
#define V_D_MOD1_K              g_controller_ctom.net_signals[9]    //          |
#define REF_K                   g_controller_ctom.net_signals[10]   //          |
#define Q_K_1                   g_controller_ctom.net_signals[11]   //        -----
 ...
 */
#define Q_K                     g_controller_ctom.net_signals[12]
#define I_LOAD_ERROR            g_controller_ctom.net_signals[13]
...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(29, 0, 4, false, V_C_MOD1_K.u8);
    create_bsmp_var(30, 0, 4, false, MOD1_DCLINK_VOLTAGE.u8);
    create_bsmp_var(31, 0, 4, false, MOD1_LOAD_VOLTAGE.u8);
    create_bsmp_var(32, 0, 4, false, MOD1_TEMPERATURE.u8);
    create_bsmp_var(33, 0, 4, false, DUTY_CYCLE_MOD_1.u8);
}
