...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(32, 0, 4, false, I_IGBT_1_MOD_1.u8);
    create_bsmp_var(33, 0, 4, false, I_IGBT_2_MOD_1.u8);
    create_bsmp_var(34, 0, 4, false, I_IGBT_1_MOD_2.u8);
    create_bsmp_var(35, 0, 4, false, I_IGBT_2_MOD_2.u8);
    create_bsmp_var(36, 0, 4, false, I_IGBT_1_MOD_3.u8);
    create_bsmp_var(37, 0, 4, false, I_IGBT_2_MOD_3.u8);
    create_bsmp_var(38, 0, 4, false, I_IGBT_1_MOD_4.u8);
    create_bsmp_var(39, 0, 4, false, I_IGBT_2_MOD_4.u8);

    create_bsmp_var(40, 0, 4, false, V_DCLINK_MOD_1.u8);
    create_bsmp_var(41, 0, 4, false, V_DCLINK_MOD_2.u8);
    create_bsmp_var(42, 0, 4, false, V_DCLINK_MOD_3.u8);
    create_bsmp_var(43, 0, 4, false, V_DCLINK_MOD_4.u8);

    create_bsmp_var(44, 0, 4, false, DUTY_MEAN.u8);
    create_bsmp_var(45, 0, 4, false, DUTY_ARMS_DIFF.u8);
    create_bsmp_var(46, 0, 4, false, DUTY_CYCLE_IGBT_1_MOD_1.u8);
    create_bsmp_var(47, 0, 4, false, DUTY_CYCLE_IGBT_2_MOD_1.u8);
    create_bsmp_var(48, 0, 4, false, DUTY_CYCLE_IGBT_1_MOD_2.u8);
    create_bsmp_var(49, 0, 4, false, DUTY_CYCLE_IGBT_2_MOD_2.u8);
    create_bsmp_var(50, 0, 4, false, DUTY_CYCLE_IGBT_1_MOD_3.u8);
    create_bsmp_var(51, 0, 4, false, DUTY_CYCLE_IGBT_2_MOD_3.u8);
    create_bsmp_var(52, 0, 4, false, DUTY_CYCLE_IGBT_1_MOD_4.u8);
    create_bsmp_var(53, 0, 4, false, DUTY_CYCLE_IGBT_2_MOD_4.u8);

    create_bsmp_var(54, 0, 4, false, iib_fap_2p2s[0].Vin.u8);
    create_bsmp_var(55, 0, 4, false, iib_fap_2p2s[0].Vout.u8);
    create_bsmp_var(56, 0, 4, false, iib_fap_2p2s[0].IoutA1.u8);
    create_bsmp_var(57, 0, 4, false, iib_fap_2p2s[0].IoutA2.u8);
    create_bsmp_var(58, 0, 4, false, iib_fap_2p2s[0].TempIGBT1.u8);
    create_bsmp_var(59, 0, 4, false, iib_fap_2p2s[0].TempIGBT2.u8);
    create_bsmp_var(60, 0, 4, false, iib_fap_2p2s[0].DriveVoltage.u8);
    create_bsmp_var(61, 0, 4, false, iib_fap_2p2s[0].Drive1Current.u8);
    create_bsmp_var(62, 0, 4, false, iib_fap_2p2s[0].Drive2Current.u8);
    create_bsmp_var(63, 0, 4, false, iib_fap_2p2s[0].TempL.u8);
    create_bsmp_var(64, 0, 4, false, iib_fap_2p2s[0].TempHeatSink.u8);

    create_bsmp_var(65, 0, 4, false, iib_fap_2p2s[1].Vin.u8);
    create_bsmp_var(66, 0, 4, false, iib_fap_2p2s[1].Vout.u8);
    create_bsmp_var(67, 0, 4, false, iib_fap_2p2s[1].IoutA1.u8);
    create_bsmp_var(68, 0, 4, false, iib_fap_2p2s[1].IoutA2.u8);
    create_bsmp_var(69, 0, 4, false, iib_fap_2p2s[1].TempIGBT1.u8);
    create_bsmp_var(70, 0, 4, false, iib_fap_2p2s[1].TempIGBT2.u8);
    create_bsmp_var(71, 0, 4, false, iib_fap_2p2s[1].DriveVoltage.u8);
    create_bsmp_var(72, 0, 4, false, iib_fap_2p2s[1].Drive1Current.u8);
    create_bsmp_var(73, 0, 4, false, iib_fap_2p2s[1].Drive2Current.u8);
    create_bsmp_var(74, 0, 4, false, iib_fap_2p2s[1].TempL.u8);
    create_bsmp_var(75, 0, 4, false, iib_fap_2p2s[1].TempHeatSink.u8);

    create_bsmp_var(76, 0, 4, false, iib_fap_2p2s[2].Vin.u8);
    create_bsmp_var(77, 0, 4, false, iib_fap_2p2s[2].Vout.u8);
    create_bsmp_var(78, 0, 4, false, iib_fap_2p2s[2].IoutA1.u8);
    create_bsmp_var(79, 0, 4, false, iib_fap_2p2s[2].IoutA2.u8);
    create_bsmp_var(80, 0, 4, false, iib_fap_2p2s[2].TempIGBT1.u8);
    create_bsmp_var(81, 0, 4, false, iib_fap_2p2s[2].TempIGBT2.u8);
    create_bsmp_var(82, 0, 4, false, iib_fap_2p2s[2].DriveVoltage.u8);
    create_bsmp_var(83, 0, 4, false, iib_fap_2p2s[2].Drive1Current.u8);
    create_bsmp_var(84, 0, 4, false, iib_fap_2p2s[2].Drive2Current.u8);
    create_bsmp_var(85, 0, 4, false, iib_fap_2p2s[2].TempL.u8);
    create_bsmp_var(86, 0, 4, false, iib_fap_2p2s[2].TempHeatSink.u8);

    create_bsmp_var(87, 0, 4, false, iib_fap_2p2s[3].Vin.u8);
    create_bsmp_var(88, 0, 4, false, iib_fap_2p2s[3].Vout.u8);
    create_bsmp_var(89, 0, 4, false, iib_fap_2p2s[3].IoutA1.u8);
    create_bsmp_var(90, 0, 4, false, iib_fap_2p2s[3].IoutA2.u8);
    create_bsmp_var(91, 0, 4, false, iib_fap_2p2s[3].TempIGBT1.u8);
    create_bsmp_var(92, 0, 4, false, iib_fap_2p2s[3].TempIGBT2.u8);
    create_bsmp_var(93, 0, 4, false, iib_fap_2p2s[3].DriveVoltage.u8);
    create_bsmp_var(94, 0, 4, false, iib_fap_2p2s[3].Drive1Current.u8);
    create_bsmp_var(95, 0, 4, false, iib_fap_2p2s[3].Drive2Current.u8);
    create_bsmp_var(96, 0, 4, false, iib_fap_2p2s[3].TempL.u8);
    create_bsmp_var(97, 0, 4, false, iib_fap_2p2s[3].TempHeatSink.u8);

    create_bsmp_var(98, 0, 4, false, IIB_ITLK_REG_MOD_1.u8);
    create_bsmp_var(99, 0, 4, false, IIB_ITLK_REG_MOD_2.u8);
    create_bsmp_var(100, 0, 4, false, IIB_ITLK_REG_MOD_3.u8);
    create_bsmp_var(101, 0, 4, false, IIB_ITLK_REG_MOD_4.u8);

    create_bsmp_var(102, 0, 4, false, I_MOD_1.u8);
    create_bsmp_var(103, 0, 4, false, I_MOD_2.u8);
    create_bsmp_var(104, 0, 4, false, I_MOD_3.u8);
    create_bsmp_var(105, 0, 4, false, I_MOD_4.u8);
}
