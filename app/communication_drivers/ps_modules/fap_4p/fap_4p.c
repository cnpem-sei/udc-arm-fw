...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(58, 0, 4, false, iib_fap_4p[0].GroundLeakage.u8);

    create_bsmp_var(59, 0, 4, false, iib_fap_4p[0].Vin.u8);
    create_bsmp_var(60, 0, 4, false, iib_fap_4p[0].Vout.u8);
    create_bsmp_var(61, 0, 4, false, iib_fap_4p[0].IoutA1.u8);
    create_bsmp_var(62, 0, 4, false, iib_fap_4p[0].IoutA2.u8);
    create_bsmp_var(63, 0, 4, false, iib_fap_4p[0].TempIGBT1.u8);
    create_bsmp_var(64, 0, 4, false, iib_fap_4p[0].TempIGBT2.u8);
    create_bsmp_var(65, 0, 4, false, iib_fap_4p[0].DriverVoltage.u8);
    create_bsmp_var(66, 0, 4, false, iib_fap_4p[0].Driver1Current.u8);
    create_bsmp_var(67, 0, 4, false, iib_fap_4p[0].Driver2Current.u8);
    create_bsmp_var(68, 0, 4, false, iib_fap_4p[0].TempL.u8);
    create_bsmp_var(69, 0, 4, false, iib_fap_4p[0].TempHeatSink.u8);
    ...
    create_bsmp_var(85, 0, 4, false, iib_fap_4p[1].BoardTemperature.u8);
    create_bsmp_var(86, 0, 4, false, iib_fap_4p[1].RelativeHumidity.u8);
    create_bsmp_var(87, 0, 4, false, iib_fap_4p[1].InterlocksRegister.u8);
    create_bsmp_var(88, 0, 4, false, iib_fap_4p[1].AlarmsRegister.u8);

    create_bsmp_var(89, 0, 4, false, iib_fap_4p[2].Vin.u8);
    create_bsmp_var(90, 0, 4, false, iib_fap_4p[2].Vout.u8);
    create_bsmp_var(91, 0, 4, false, iib_fap_4p[2].IoutA1.u8);
    create_bsmp_var(92, 0, 4, false, iib_fap_4p[2].IoutA2.u8);
    create_bsmp_var(93, 0, 4, false, iib_fap_4p[2].TempIGBT1.u8);
    create_bsmp_var(94, 0, 4, false, iib_fap_4p[2].TempIGBT2.u8);
    create_bsmp_var(95, 0, 4, false, iib_fap_4p[2].DriverVoltage.u8);
    create_bsmp_var(96, 0, 4, false, iib_fap_4p[2].Driver1Current.u8);
    create_bsmp_var(97, 0, 4, false, iib_fap_4p[2].Driver2Current.u8);
    create_bsmp_var(98, 0, 4, false, iib_fap_4p[2].TempL.u8);
    create_bsmp_var(99, 0, 4, false, iib_fap_4p[2].TempHeatSink.u8);
    create_bsmp_var(100, 0, 4, false, iib_fap_4p[2].BoardTemperature.u8);
    create_bsmp_var(101, 0, 4, false, iib_fap_4p[2].RelativeHumidity.u8);
    create_bsmp_var(102, 0, 4, false, iib_fap_4p[2].InterlocksRegister.u8);
    create_bsmp_var(103, 0, 4, false, iib_fap_4p[2].AlarmsRegister.u8);

    create_bsmp_var(104, 0, 4, false, iib_fap_4p[3].Vin.u8);
    create_bsmp_var(105, 0, 4, false, iib_fap_4p[3].Vout.u8);
    create_bsmp_var(106, 0, 4, false, iib_fap_4p[3].IoutA1.u8);
    create_bsmp_var(107, 0, 4, false, iib_fap_4p[3].IoutA2.u8);
    create_bsmp_var(108, 0, 4, false, iib_fap_4p[3].TempIGBT1.u8);
    create_bsmp_var(109, 0, 4, false, iib_fap_4p[3].TempIGBT2.u8);
    create_bsmp_var(110, 0, 4, false, iib_fap_4p[3].DriverVoltage.u8);
    create_bsmp_var(111, 0, 4, false, iib_fap_4p[3].Driver1Current.u8);
    create_bsmp_var(112, 0, 4, false, iib_fap_4p[3].Driver2Current.u8);
    create_bsmp_var(113, 0, 4, false, iib_fap_4p[3].TempL.u8);
    create_bsmp_var(114, 0, 4, false, iib_fap_4p[3].TempHeatSink.u8);
    create_bsmp_var(115, 0, 4, false, iib_fap_4p[3].BoardTemperature.u8);
    create_bsmp_var(116, 0, 4, false, iib_fap_4p[3].RelativeHumidity.u8);
    create_bsmp_var(117, 0, 4, false, iib_fap_4p[3].InterlocksRegister.u8);
    create_bsmp_var(118, 0, 4, false, iib_fap_4p[3].AlarmsRegister.u8);

    create_bsmp_var(119, 0, 4, false, g_ipc_ctom.ps_module[0].ps_alarms.u8);
...
static void handle_can_data(volatile uint8_t *data, volatile unsigned long id)
{
    ...
    switch(id_var)
    {
        case 0:
        {
            memcpy((void *)iib_fap_4p[module].Vin.u8, (const void *)&data[0], (size_t)4);
            memcpy((void *)(&V_DCLINK_MOD_1.f + module), (const void *)&data[0], (size_t)4);
            memcpy((void *)iib_fap_4p[module].Vout.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 1:
        {
        	memcpy((void *)iib_fap_4p[module].IoutA1.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].IoutA2.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 2:
        {
        	memcpy((void *)iib_fap_4p[module].DriverVoltage.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].GroundLeakage.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 3:
        {
        	memcpy((void *)iib_fap_4p[module].Driver1Current.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].Driver2Current.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 4:
        {
            memcpy((void *)iib_fap_4p[module].TempIGBT1.u8, (const void *)&data[0], (size_t)4);
            memcpy((void *)iib_fap_4p[module].TempIGBT2.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 5:
        {
        	memcpy((void *)iib_fap_4p[module].TempL.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].TempHeatSink.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 6:
        {
        	memcpy((void *)iib_fap_4p[module].BoardTemperature.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].RelativeHumidity.u8, (const void *)&data[4], (size_t)4);

            break;
        }
        case 7:
        {
        	memcpy((void *)iib_fap_4p[module].InterlocksRegister.u8, (const void *)&data[0], (size_t)4);
        	memcpy((void *)iib_fap_4p[module].AlarmsRegister.u8, (const void *)&data[4], (size_t)4);

            if(iib_fap_4p[module].InterlocksRegister.u32 > 0)
        	{
