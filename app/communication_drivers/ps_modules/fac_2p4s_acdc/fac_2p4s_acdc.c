...
static void bsmp_init_server(void)
{
    ...
    create_bsmp_var(40, MOD_A_ID, 4, false, fac_is[MOD_A_ID].VdcLink.u8);
    ...
    create_bsmp_var(40, MOD_B_ID, 4, false, fac_is[MOD_B_ID].VdcLink.u8);
    ...
    create_bsmp_var(45, MOD_A_ID, 4, false, fac_cmd[MOD_A_ID].TempL.u8);
    create_bsmp_var(46, MOD_A_ID, 4, false, fac_cmd[MOD_A_ID].TempHeatSink.u8);
    ...
    create_bsmp_var(45, MOD_B_ID, 4, false, fac_cmd[MOD_B_ID].TempL.u8);
    create_bsmp_var(46, MOD_B_ID, 4, false, fac_cmd[MOD_B_ID].TempHeatSink.u8);
